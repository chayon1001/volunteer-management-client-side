  ...
  return (
    <div className="max-w-7xl mx-auto p-4 flex flex-col lg:flex-row justify-between items-start mt-10 rounded-xl mb-10 bg-gray-100">
      ...
      <div className="w-full lg:w-1/2 mb-8 lg:mb-0">
        <h2 className="text-2xl font-bold mb-4 dark:text-gray-300 dark:font-bold">
          Contact us
        </h2>
        <p className="text-gray-600 mb-6">
          The Contact Us section is an essential part of your Volunteer
          Management Website, allowing visitors, volunteers, and organizations
